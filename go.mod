...
require (
	...
	gitlab.p1staff.com/backend/tantan-backend-common v1.39.17
...
require (
	...
	github.com/icza/bitio v0.9.0 // indirect
	...
	github.com/lemonlinger/zap-syslog v0.2.2 // indirect
	...
	github.com/zhaoyuankui/goutil v1.0.6 // indirect
	gitlab.p1staff.com/backend/jaeger-client-go v4.2.2+incompatible // indirect
	gitlab.p1staff.com/backend/tantan-backend-tracer v1.2.6 // indirect
	gitlab.p1staff.com/backend/tantan-domain-schema v1.44.58 // indirect
	gitlab.p1staff.com/common/service-registry/proto v0.1.12 // indirect
	gitlab.p1staff.com/common/slf v1.1.12 // indirect
